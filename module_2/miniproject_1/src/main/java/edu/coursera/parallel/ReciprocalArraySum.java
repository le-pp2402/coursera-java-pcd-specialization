...
public final class ReciprocalArraySum {
     ...
     * 
     * @param chunk     T e chunk to compute the start of
     ...
     * given there are a certain number of chunks.
     * 
     * @param chunk     T e chunk to compute the end of
     * @param nChunks   The number of chunks created
     * @param nElements The number of elements to chunk across
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
         ...
         * 
         * Constructor.
         * setStartIndexInclusive Set the starting index to begin
         * parallel traversal a .
         * 
         * @param setEndIn exExclusive Set ending index for parallel traversal.
